...
replicator.stage.binlog-to-q.filters=@{REPL_SVC_EXTRACTOR_FILTERS}
...
replicator.stage.q-to-thl.filters=@{REPL_SVC_THL_FILTERS}
...
replicator.stage.q-to-dbms.filters=@{REPL_SVC_APPLIER_FILTERS}
replicator.stage.q-to-dbms.taskCount=${replicator.global.apply.channels}
replicator.stage.q-to-dbms.blockCommitRowCount=@{REPL_SVC_APPLIER_BUFFER_SIZE}
